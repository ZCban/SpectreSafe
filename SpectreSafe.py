...
class Spoofer:
    ...
    class ServiceManager:
        ...
        def block_telemetry_domains():
            try:
                with open(r'C:\Windows\System32\drivers\etc\hosts', 'a') as hosts_file:
                    ...
                    hosts_file.write("127.0.0.1 vortex-win.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 telecommand.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 telecommand.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 oca.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 oca.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 sqm.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 sqm.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("\n127.0.0.1 a-0001.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0002.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0003.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0004.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0005.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0006.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0007.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0008.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-0009.a-msedge.net\n")
                    hosts_file.write("127.0.0.1 a-msedge.net\n")
                    hosts_file.write("127.0.0.1 asimov-win.settings.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 content.windows.microsoft.com\n")
                    hosts_file.write("127.0.0.1 df.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 diagnostic.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 dl.delivery.mp.microsoft.com\n")
                    hosts_file.write("127.0.0.1 geo.settings.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 i1.services.social.microsoft.com\n")
                    hosts_file.write("127.0.0.1 i1.services.social.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 ipv6.msftconnecttest.com\n")
                    hosts_file.write("127.0.0.1 msedge.net\n")
                    hosts_file.write("127.0.0.1 msnbot-65-55-108-23.search.msn.com\n")
                    hosts_file.write("127.0.0.1 msntest.serving-sys.com\n")
                    hosts_file.write("127.0.0.1 oca.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 oca.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 pre.footprintpredict.com\n")
                    hosts_file.write("127.0.0.1 redir.metaservices.microsoft.com\n")
                    hosts_file.write("127.0.0.1 reports.wes.df.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 services.wes.df.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 settings-sandbox.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 settings-win.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 sqm.df.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 sqm.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 ssw.live.com\n")
                    hosts_file.write("127.0.0.1 statsfe1.ws.microsoft.com\n")
                    hosts_file.write("127.0.0.1 survey.watson.microsoft.com\n")
                    hosts_file.write("127.0.0.1 telecommand.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 telecommand.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 telecommand.telemetry.microsoft.com.nsatc.net\n")
                    hosts_file.write("127.0.0.1 telemetry.appex.bing.net\n")
                    hosts_file.write("127.0.0.1 telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 telemetry.urs.microsoft.com\n")
                    hosts_file.write("127.0.0.1 vortex-sandbox.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 vortex-win.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 vortex.data.microsoft.com\n")
                    hosts_file.write("127.0.0.1 watson.live.com\n")
                    hosts_file.write("127.0.0.1 watson.microsoft.com\n")
                    hosts_file.write("127.0.0.1 watson.ppe.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 wes.df.telemetry.microsoft.com\n")
                    hosts_file.write("127.0.0.1 willcroftg.services.ms\n")
                    hosts_file.write("127.0.0.1 www.msftncsi.com\n")

                    # Discord
                    hosts_file.write("\n127.0.0.1 discordapp.com\n")
                    hosts_file.write("127.0.0.1 www.discordapp.com\n")
                    hosts_file.write("127.0.0.1 cdn.discordapp.com\n")
                    hosts_file.write("127.0.0.1 status.discordapp.com\n")
                    hosts_file.write("127.0.0.1 telemetry.discordapp.com\n")
                    
                    # Nvidia
                    hosts_file.write("127.0.0.1 telemetry.nvidia.com\n")
                    hosts_file.write("127.0.0.1 gfe.nvidia.com\n")
                    hosts_file.write("127.0.0.1 services.gfe.nvidia.com\n")
                    hosts_file.write("127.0.0.1 telemetry.gfe.nvidia.com\n")
                    hosts_file.write("127.0.0.1 events.gfe.nvidia.com\n")
                    
                    # Valorant
                    hosts_file.write("127.0.0.1 data.riotgames.com\n")
                    hosts_file.write("127.0.0.1 telemetry.riotgames.com\n")
                    hosts_file.write("127.0.0.1 log-ingestion.riotgames.com\n")
                    hosts_file.write("127.0.0.1 metrics.riotgames.com\n")
                    hosts_file.write("127.0.0.1 tracking.riotgames.com\n")
                    hosts_file.write("127.0.0.1 data.valorant.com\n")
                    hosts_file.write("127.0.0.1 telemetry.valorant.com\n")
                    hosts_file.write("127.0.0.1 log-ingestion.valorant.com\n")
                    hosts_file.write("127.0.0.1 metrics.valorant.com\n")
                    hosts_file.write("127.0.0.1 tracking.valorant.com\n")

                    # Steam
                    hosts_file.write("\n127.0.0.1 telemetry.steampowered.com\n")
                    hosts_file.write("127.0.0.1 metrics.steampowered.com\n")
                    hosts_file.write("127.0.0.1 stats.steampowered.com\n")
                    hosts_file.write("127.0.0.1 data.steampowered.com\n")
                    hosts_file.write("127.0.0.1 beacon.steampowered.com\n")
                    hosts_file.write("127.0.0.1 steamtelemetry.com\n")
                    hosts_file.write("127.0.0.1 steamtelemetry.net\n")

                    # Rust
                    hosts_file.write("\n127.0.0.1 telemetry.facepunch.com\n")
                    hosts_file.write("127.0.0.1 stats.facepunch.com\n")
                    hosts_file.write("127.0.0.1 analytics.facepunch.com\n")
                    hosts_file.write("127.0.0.1 data.facepunch.com\n")
                    hosts_file.write("127.0.0.1 events.facepunch.com\n")
                    hosts_file.write("127.0.0.1 beacon.facepunch.com\n")

                    # Fortnite ed Epic Games
                    hosts_file.write("\n127.0.0.1 telemetry.epicgames.com\n")
                    hosts_file.write("127.0.0.1 telemetry.fortnite.com\n")
                    hosts_file.write("127.0.0.1 analytics.fortnite.com\n")
                    hosts_file.write("127.0.0.1 analytics.epicgames.com\n")
                    hosts_file.write("127.0.0.1 data.epicgames.com\n")
                    hosts_file.write("127.0.0.1 data.fortnite.com\n")
                    hosts_file.write("127.0.0.1 events.epicgames.com\n")
                    hosts_file.write("127.0.0.1 events.fortnite.com\n")
                    hosts_file.write("127.0.0.1 tracking.epicgames.com\n")
                    hosts_file.write("127.0.0.1 tracking.fortnite.com\n")

                    # Apex Legends
                    hosts_file.write("\n127.0.0.1 telemetry.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 metrics.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 analytics.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 data.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 events.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 tracking.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 beacon.apexlegends.com\n")
                    hosts_file.write("127.0.0.1 telemetry.ea.com\n")
                    hosts_file.write("127.0.0.1 metrics.ea.com\n")
                    hosts_file.write("127.0.0.1 analytics.ea.com\n")
                    hosts_file.write("127.0.0.1 data.ea.com\n")
                    hosts_file.write("127.0.0.1 events.ea.com\n")
                    hosts_file.write("127.0.0.1 tracking.ea.com\n")
                    hosts_file.write("127.0.0.1 beacon.ea.com\n")

                    # PUBG
                    hosts_file.write("\n127.0.0.1 telemetry.pubg.com\n")
                    hosts_file.write("127.0.0.1 metrics.pubg.com\n")
                    hosts_file.write("127.0.0.1 analytics.pubg.com\n")
                    hosts_file.write("127.0.0.1 data.pubg.com\n")
                    hosts_file.write("127.0.0.1 events.pubg.com\n")
                    hosts_file.write("127.0.0.1 tracking.pubg.com\n")
                    hosts_file.write("127.0.0.1 beacon.pubg.com\n")

                    # Farlight 84
                    hosts_file.write("\n127.0.0.1 telemetry.farlight84.com\n")
                    hosts_file.write("127.0.0.1 metrics.farlight84.com\n")
                    hosts_file.write("127.0.0.1 analytics.farlight84.com\n")
                    hosts_file.write("127.0.0.1 data.farlight84.com\n")
                    hosts_file.write("127.0.0.1 events.farlight84.com\n")
                    hosts_file.write("127.0.0.1 tracking.farlight84.com\n")
                    hosts_file.write("127.0.0.1 beacon.farlight84.com\n")

                    # Genshin Impact
                    hosts_file.write("\n127.0.0.1 log-upload-os.mihoyo.com\n")
                    hosts_file.write("127.0.0.1 overseauspider.yuanshen.com\n")
                    hosts_file.write("127.0.0.1 oslog-upload.mihoyo.com\n")
                    hosts_file.write("127.0.0.1 log-upload.mihoyo.com\n")
                    hosts_file.write("127.0.0.1 gitelemetry.gi.e.dhs.mihoyo.com\n")
                    hosts_file.write("127.0.0.1 log-upload-genshin.mihoyo.com\n")
                    hosts_file.write("127.0.0.1 os-genshin.mihoyo.com\n")

                    # League of Legends
                    hosts_file.write("\n127.0.0.1 l3cdn.riotgames.com\n")
                    hosts_file.write("127.0.0.1 l3cdn.lol.riotgames.com\n")
                    hosts_file.write("127.0.0.1 l3cdn.na.lol.riotgames.com\n")
                    hosts_file.write("127.0.0.1 l3cdn.euw.lol.riotgames.com\n")
                    hosts_file.write("127.0.0.1 l3cdn.eune.lol.riotgames.com\n")

                    # Call of Duty
                    hosts_file.write("\n127.0.0.1 telemetry.callofduty.com\n")
                    hosts_file.write("127.0.0.1 metrics.callofduty.com\n")
                    hosts_file.write("127.0.0.1 analytics.callofduty.com\n")
                    hosts_file.write("127.0.0.1 data.callofduty.com\n")
                    hosts_file.write("127.0.0.1 events.callofduty.com\n")
                    hosts_file.write("127.0.0.1 tracking.callofduty.com\n")
                    hosts_file.write("127.0.0.1 beacon.callofduty.com\n")

                    # FIFA
                    hosts_file.write("\n127.0.0.1 telemetry.fifa.com\n")
                    hosts_file.write("127.0.0.1 metrics.fifa.com\n")
                    hosts_file.write("127.0.0.1 analytics.fifa.com\n")
                    hosts_file.write("127.0.0.1 data.fifa.com\n")
                    hosts_file.write("127.0.0.1 events.fifa.com\n")
                    hosts_file.write("127.0.0.1 tracking.fifa.com\n")
                    hosts_file.write("127.0.0.1 beacon.fifa.com\n")
        ...
        def disable_activity_history():
            try:
                key = winreg.OpenKey(reg.HKEY_LOCAL_MACHINE, r'SOFTWARE\Policies\Microsoft\Windows\System', 0, winreg.KEY_SET_VALUE)
        ...
        def disable_feedback_notifications():
            try:
                ...
                winreg.CloseKey(key)
                key = reg.OpenKey(reg.HKEY_CURRENT_USER, r'SOFTWARE\Microsoft\Siuf\Rules', 0, winreg.KEY_SET_VALUE)
        ...
        def main():
            ...
            Spoofer.ServiceManager.block_telemetry_domains()
            print('Blocking telemetry domains completed.')
            Spoofer.ServiceManager.disable_activity_history()
            Spoofer.ServiceManager.disable_location_tracking()
            Spoofer.ServiceManager.disable_diagnostics_feedback()
            Spoofer.ServiceManager.disable_cortana()
            Spoofer.ServiceManager.disable_typing_data_collection()
            Spoofer.ServiceManager.disable_voice_data_collection()
            Spoofer.ServiceManager.disable_feedback_notifications()
            Spoofer.ServiceManager.disable_edge_privacy_settings()
            print('Disabling additional privacy-related settings completed.')
